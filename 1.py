...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param3).displayName + " (｡•́︿•̀｡) Sampai jumpa lagi dengan yuki kak ")
    except Exception as e:
        print e
...
def NOTIFIED_LEAVE_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + "ヽ(●ﾟ´Д｀ﾟ●)ﾉﾟ kenapa left group kak ")
    except Exception as e:
        print e
